...
namespace PanettoneGames
{
    ...
    public class DualPlayEditor : UnityEditor.EditorWindow
    {
        ...
        private const int windowMinWidth = 120;
        private  static int windowMinHeight = 120;
        ...
        GUILayout.BeginArea(bodyRect);
            ...
            else //Original Copy
            {
                ...
                {
                    scrollPos = EditorGUILayout.BeginScrollView(scrollPos, GUILayout.ExpandWidth(true), GUILayout.Height(45));
